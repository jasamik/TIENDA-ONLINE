...
class AjaxComercio{
	...
	public $llavePublicaCulqi;
	public $llaveSecretaCulqi;
	...
	public function ajaxCambiarInformacion(){
		...
		$datos = array("impuesto"=>$this->impuesto,
						...
						"llavePublicaCulqi"=>$this->llavePublicaCulqi,
						"llaveSecretaCulqi"=>$this->llaveSecretaCulqi);
...
if(isset($_POST["impuesto"])){
	...
	$informacion -> llavePublicaCulqi = $_POST["llavePublicaCulqi"];
	$informacion -> llaveSecretaCulqi = $_POST["llaveSecretaCulqi"];
