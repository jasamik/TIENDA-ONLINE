...
class ModeloComercio{
	...
	static public function mdlActualizarInformacion($tabla, $id, $datos){
		...
		pais = :pais,
		llavePublicaCulqi = :llavePublicaCulqi, 
		llaveSecretaCulqi = :llaveSecretaCulqi 
		WHERE id = :id");
		...
		$stmt->bindParam(":llavePublicaCulqi", $datos["llavePublicaCulqi"], PDO::PARAM_STR); 
		$stmt->bindParam(":llaveSecretaCulqi", $datos["llaveSecretaCulqi"], PDO::PARAM_STR);
		$stmt->bindParam(":id", $id, PDO::PARAM_INT);
