...
var llaveSecretaCulqi = $("#llaveSecretaCulqi").val();
...
$(".cambioInformacion").change(function(){
	...
	llavePublicaCulqi = $("#llavePublicaCulqi").val();
	llaveSecretaCulqi = $("#llaveSecretaCulqi").val();
...
function cambiarInformacion(){
	...
	datos.append("llavePublicaCulqi", llavePublicaCulqi);
	datos.append("llaveSecretaCulqi", llaveSecretaCulqi);
