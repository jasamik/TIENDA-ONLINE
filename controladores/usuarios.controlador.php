...
class ControladorUsuarios{
			...
			if(preg_match('/^[a-zA-ZñÑáéíóúÁÉÍÓÚ ]+$/', $_POST["regUsuario"]) &&
			   ...
			   preg_match('/^[a-zA-Z0-9]+$/', $_POST["regPassword"])){
				...
				if($respuesta == "ok"){
					...
					$mail->setFrom('soporte@aquariadepot.com', 'Aquaria Depot');

					$mail->addReplyTo('soporte@aquariadepot.com', 'Aquaria Depot');
					...
					$mail->msgHTML('<div style="width:100%; background:#eee; position:relative; font-family:sans-serif; padding-bottom:40px">
						...
						<center>
							...
							<img style="padding:20px; width:10%" src="https://www.aquariadepot.com/vistas/img/cabeceras/logo.png">
						...
						<div style="position:relative; margin:auto; width:600px; background:white; padding:20px">
							...
							<h4 style="font-weight:100; color:#999; padding:0 20px">Para comenzar a usar su cuenta de Aquaria Depot, debe confirmar su dirección de correo electrónico</h4>

							<a href="'.$url.'verificar/'.$encriptarEmail.'" target="_blank" style="text-decoration:none">

							<div style="line-height:60px; background:#3498db; width:60%; color:white">Verifique su dirección de correo electrónico</div>
				...
				if($respuesta["email"] == $_POST["ingEmail"] && $respuesta["password"] == $encriptar){
					...
					if($respuesta["verificacion"] == 1){
					    ...
					    if(isset($_POST["g-recaptcha-response"])){
					        ...
					        $secret = "6Lc1m7oUAAAAAP2UoiBC15Iy5C0eTwjFujLoBrjM";
			...
			if(preg_match('/^[^0-9][a-zA-Z0-9_]+([.][a-zA-Z0-9_]+)*[@][a-zA-Z0-9_]+([.][a-zA-Z0-9_]+)*[.][a-zA-Z]{2,4}$/', $_POST["passEmail"])){
				...
				if($respuesta1){
					...
					if($respuesta2  == "ok"){
						...
						$mail->addReplyTo('jasamik@hotmail.com', 'Aquaria Depot');
						...
						$mail->msgHTML('<div style="width:100%; background:#eee; position:relative; font-family:sans-serif; padding-bottom:40px">
								...
								<div style="position:relative; margin:auto; width:600px; background:white; padding:20px">
									...
									<div style="line-height:60px; background:#3498db; width:60%; color:white">Ingrese nuevamente al sitio</div>
	...
	static public function ctrMostrarVideos($item){

		$tabla = "deseos";

		$respuesta = ModeloUsuarios::mdlMostrarVideos($tabla, $item);
		...
		if(isset($_POST['mensajeContactenos'])){
			...
			preg_match('/^[^0-9][a-zA-Z0-9_]+([.][a-zA-Z0-9_]+)*[@][a-zA-Z0-9_]+([.][a-zA-Z0-9_]+)*[.][a-zA-Z]{2,4}$/', $_POST["emailContactenos"])){
				...
				=============================================*/
					...
					$mail->addAddress("jasamik@hotmail.com");

					$mail->msgHTML('

						<div style="width:100%; background:#eee; position:relative; font-family:sans-serif; padding-bottom:40px">

						<center><img style="padding:20px; width:10%" src="https://www.aquariadepot.com/vistas/img/cabeceras/logo.png"></center>
