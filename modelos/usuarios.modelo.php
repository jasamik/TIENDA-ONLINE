...
class ModeloUsuarios{
	...
	static public function mdlRegistroUsuario($tabla, $datos){
		...
		$stmt = Conexion::conectar()->prepare("INSERT INTO $tabla(nombre, password, email, foto, modo, verificacion, emailEncriptado, telefono) VALUES (:nombre, :password, :email, :foto, :modo, :verificacion, :emailEncriptado, :telefono)");
	...
	static public function mdlActualizarPerfil($tabla, $datos){
		...
		$stmt = Conexion::conectar()->prepare("UPDATE $tabla SET nombre = :nombre, email = :email, password = :password, foto = :foto, telefono = :telefono  WHERE id = :id");
	...
	static public function mdlMostrarDeseos($tabla, $item){
		...
		$stmt = Conexion::conectar()->prepare("SELECT * FROM deseos inner join productos on deseos.id_producto=productos.id WHERE productos.precio<> 0  and id_usuario = :id_usuario ORDER BY deseos.id DESC");
	...
	static public function mdlMostrarVideos($tabla, $item){
