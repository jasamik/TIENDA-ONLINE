		...
		<div class="row">
			...
			<div class="col-md-3 col-sm-6 col-xs-12 text-left infoContacto">
				...
				<h5>
					...
					<i class="fa fa-phone-square" aria-hidden="true"></i> (511) 953 351 53

					<br><br>

					<i class="fa fa-envelope" aria-hidden="true"></i> soporte@aquariadepot.com

					<br><br>

					<i class="fa fa-map-marker" aria-hidden="true"></i> Av. Los Nenufares 512 Vipol - Callao

					<br><br>
					Lima | Perú

				</h5>
				<iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3902.4635866064623!2d-77.1003867859172!3d-12.011572791490776!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x9105ce9cc07dd6b3%3A0x1fbe556f34a02a46!2sAv.%20los%20Nenufares%20512%2C%20Callao%2007036!5e0!3m2!1ses-419!2spe!4v1591820053484!5m2!1ses-419!2spe" width="100%" height="200" frameborder="0" style="border:0;" allowfullscreen></iframe>
			</div>
			...
			<div class="col-lg-4 col-md-3 col-sm-6 col-xs-12 formContacto">
				...
				<form role="form" method="post" id="formenvio" onsubmit="return validarContactenos()">
	...
	<div class="container">
		...
		<div class="row">
			...
			<div class="col-sm-6 col-xs-12 text-left text-muted">
				...
				<h5>&copy; 2019 Todos los derechos reservados. Sitio elaborado por Aquaria Depot</h5>
