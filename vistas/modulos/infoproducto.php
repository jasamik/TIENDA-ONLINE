			...
			?>
				...
				<?php
					...
					if($infoproducto["precio"] == 0){
						...
						echo '<h2 class="text-muted">Video Recomendado</h2>';
						...
						if($infoproducto["oferta"] == 0){
							...
							echo '<h2 class="text-muted">
								...
								<span>
									...
									PEN S/. '.$infoproducto["precioOferta"].'
...
Los videos son recomendaciones para poder mantener tu Acuario o tus Peces de la Mejor manera, son videos seleccionados exclusivamente para Ud. y incluye ficha de animales, formas de montar un acuario y uso de nuestros productos.
	...
	<div class="container">
		...
		<div class="row">
			...
			<?php if($infoproducto["precio"] == 0){?>
				<h1><small>VIDEOS RELACIONADOS</small></h1>
			<? } else { ?>
						...
						if($value["precio"] == 0){
							...
							if($value["oferta"] != 0){
								...
								echo '<h2>
										...
										<small>PEN S/. '.$value["precioOferta"].'</small>
